      ...
      <div className="h-full max-w-7xl flex items-center justify-between mx-auto">
        <div className="flex items-center">
          <div className="flex items-center mr-4">
            <h1 className="text-lg font-bold inline-block mr-4 my-2">Neekko33's Blog</h1>
          </div>
          <NavigationMenu viewport={false} className="font-semibold">
            <NavigationMenuList>
              <NavigationMenuItem>
        ...
        <div className="flex items-center h-8">
          <div className="border-r border-gray-300 pr-4">
            <Input placeholder="_(:з」∠)_" className="" />
          </div>
          <a className="h-6 w-6 ml-4 cursor-pointer" href="https://github.com/neekko33" target="_blank" rel="noopener noreferrer" title="GitHub">
